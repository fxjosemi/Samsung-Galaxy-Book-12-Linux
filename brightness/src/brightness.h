 ...
 *      byte-safe data types and checked initialization support.
 *
...
typedef struct {
    ...
    unsigned char               channelAdjustment[0x42][11 * 3];
...
extern void setBrightness(aux_t aux, displayBrightness_t *dp, int brightness);
extern void setColorProfile(aux_t aux, displayBrightness_t *dp, int colorProfileNr);
