 ...
 *      register tables use explicit unsigned byte storage.
 *
 ...
 * Color profiles
 */
extern unsigned char colorProfile0[];
extern unsigned char colorProfile1[];
extern unsigned char colorProfile2[];
extern unsigned char colorProfile3[];
extern unsigned char colorProfile4[];
extern unsigned char colorProfile5[];
extern unsigned char colorProfile6[];

extern unsigned char colorProfileAdjTableA[];
extern unsigned char colorProfileAdjTableB[];
...
extern unsigned char valuesRegAPerBrightness[];
extern unsigned char valuesRegBPerBrightness[][9];
extern unsigned char valuesRegCPerBrightness[][2];
extern unsigned char valuesRegCPerBrightness_lowMode[][2];
extern unsigned char valuesRegC2PerBrightness[];
